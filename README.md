...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-elcr184.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-elcr184.containers.anotherwebservice.com/
...
```
git clone git@github.com:tpraxedes/container-elcr184.git
cd container-elcr184
```
...
```
docker attach container-elcr184
```
